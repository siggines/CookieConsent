...
function getE(hostname) {
  switch (hostname) {
    ...
    case "hoernews.de":
      return ["cookieconsent_status=accept"];
    ...
    case "carrefour.pl":
      return ["ec4CookiesSettings=true"];
    case "welovedevs.com":
    ...
    case "cire.pl":
      return [
        ...
        "APP_A_COOKIES_FUNCTIONAL=true",
        "APP_A_COOKIES_PERFORMANCE=true",
        "APP_A_COOKIES_MARKETING=true",
        "APP_A_COOKIES_POLICY=true",
      ];
    case "kaptainmusic.com":
      return ["mandatoryCookiesAccepted=true"];
    case "voebb.onleihe.de":
      return ["onleiheTracking=true"];
    ...
    case "huizenzoeker.nl":
      return ["cookieConsent=cookie_accept"];
    case "dndbeyond.com":
      return ["cookie-consent=granted"];
    ...
    case "crown.com":
      return ["modalPolicyCookieNotAccepted=yestaccepted"];
    case "xoxo-mobile.at":
    ...
    case "ostfriesische-brandkasse.de":
      return [
        "cookie-analytics-undefined=true",
    ...
    case "ertflix.gr":
      return [
        "HAS_COOKIES_FORM_SHOWED=true",
        "ARE_REQUIRED_COOKIES_ACCEPTED=true",
        "ARE_FUNCTIONAL_COOKIES_ACCEPTED=true",
        "ARE_MARKETING_COOKIES_ACCEPTED=true",
      ];
    case "smart.com":
      return ["OptanonAlertBoxClosed=true"];
    case "kei.pl":
      return [
        "CF_GDPR_COOKIE_CONSENT_MARKETING=1",
        "CF_GDPR_COOKIE_CONSENT_PERFORMANCE=1",
        "CF_GDPR_COOKIE_CONSENT_SOCIAL=1",
    ...
    case "elearningindustry.com":
      return ["cookie_preferences=1-1-1-1"];
    case "latoquedor.com":
      return [
    ...
    case "tarifcheck-partnerprogramm.de":
      return ["mrk=yes", "stats=yes", "tech=yes"];
    case "ulm-dsl.de":
      return ["eu-cookie=1"];
    ...
    case "sportrebel.pl":
      return ["sportrebel_retry_cookie_request=1"];
    case "carry.pl":
    ...
    case "seb.se":
      return ["AcceptedCookieCategories=1%"];
    case "skyscanner.net":
    case "skyscanner.ru":
    case "skyscanner.fi":
    case "skyscanner.no":
    ...
    case "dslbank.de":
      return ["Cookieinfoauswahl=true"];
    case "nadia.gov.gr":
      return ["consent-status=111"];
    case "stevensbikes.de":
      return [
        "stv_cconsent_statistics=1",
        "stv_cconsent_external=1",
    ...
    case "ebatpro.fr":
      return ["cookie_necessity=1", "cookie_performance=1"];
    case "autohaus24.de":
    ...
    case "bokadirekt.se":
      return ["CookiePreferencesMP=Accepted"];
    case "uniqueshop.gr":
      return [
        "iccb_init=1",
        "iccb_personalization=1",
        "CookiePreferencesMP=Accepted",
        "iccb_analytics=1",
        "iccb_ads=1",
      ];
    case "hartorama.gr":
    ...
    case "cinobo.com":
      return [
        "cb_functionality=granted",
        "cb_performance=granted",
